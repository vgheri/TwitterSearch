...
namespace ApplicationLogic
{
    public class TwitterStreamingListener
    {
        ...
        {
            ConsumerKey = "x84yZdIoc8xOwXT2PlltbQ",
            ConsumerSecret = "GPr9CC0fbswDCa0L1y45rk8NGZLtyKaBBAiedb8FZM",
            AccessToken = "22067654-qIpdstJykZt6JcrIhRRFHAaKzmPp0thi6zzFDqFId",
            AccessTokenSecret = "zb2K8Gb0cmbDdif8HoRN0gkZIHkzrZy7ktSaWpgWRo"
        };
